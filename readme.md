...
2. The camera detects waste, and uses YOLO to only keep the picture of the waste.
3. A descriptive text is made with the picture of the waste
4. The text is compared to text from the database containing the sorting rules.
